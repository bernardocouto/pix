export default `
    ...
    AddTitularPessoaJuridica(contaNumero: String!, pessoaJuridicaCnpj: String!): AddPessoaJuridica @cypher(statement: "MATCH (c:Conta) WHERE c.numero = $contaNumero MATCH (p:PessoaJuridica) WHERE p.cnpj = $pessoaJuridicaCnpj MERGE (p)-[:PESSOA_JURIDICA]->(c) RETURN c, p")
`;
